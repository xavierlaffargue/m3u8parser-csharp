...
namespace M3U8Parser.Tests
{
	...
	public class LoadMasterPlaylistTests
	{
		...
		{
			var media = new StreamInf("#EXT-X-STREAM-INF:BANDWIDTH=3971374,AVERAGE-BANDWIDTH=2778321,VIDEO-RANGE=SDR,CODECS=\"hvc1.2.4.L123.B0\",RESOLUTION=1280x720,FRAME-RATE=23.976,HDCP-LEVEL=NONE,SUBTITLES=\"subtitle\"\r\nsdr_720/prog_index.m3u8");
			Assert.AreEqual("#EXT-X-STREAM-INF:BANDWIDTH=3971374,AVERAGE-BANDWIDTH=2778321,VIDEO-RANGE=SDR,CODECS=\"hvc1.2.4.L123.B0\",RESOLUTION=1280x720,FRAME-RATE=23.976,HDCP-LEVEL=NONE,SUBTITLES=\"subtitle\"\r\nsdr_720/prog_index.m3u8", media.ToString());
		}
